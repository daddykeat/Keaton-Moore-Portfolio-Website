...
const sectionIds = ["about", "skills", "projects", "motion", "experience", "contact"];
...
const spy = new IntersectionObserver(
  ...
  { rootMargin: "-40% 0px -55% 0px", threshold: [0.15, 0.3, 0.5, 0.75] }
);
  ...
  const onScroll = () => {
    ...
    if (!ticking) {
      window.requestAnimationFrame(() => {
        const move = latestY * 0.06;
        const drift = latestY * 0.01;
